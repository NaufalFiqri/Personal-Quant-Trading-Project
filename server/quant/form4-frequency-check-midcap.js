...
// Mid-cap universe, per PHASE2_INSIDER_SIGNAL_SCOPING.md follow-up: GGG
// (Graco), RLI (RLI Corp), SSD (Simpson Manufacturing), WDFC (WD-40), TTC
// (Toro), DCI (Donaldson), CW (Curtiss-Wright) - all confirmed via real
// ownership-structure checks to be institutionally-dominated with no
// founder/family control block, unlike several candidates considered and
// rejected (Watts Water: 68% Horne family voting control; Choice Hotels:
// 43% Bainum family; Lancaster Colony: 31%+ Gerlach family).
const TICKERS = ["GGG", "RLI", "SSD", "WDFC", "TTC", "DCI", "CW"];
const START_DATE = "2022-01-01";
const END_DATE = "2026-08-20"; // identical window to the mega-cap check, for direct comparability
const CLUSTER_WINDOW_DAYS = 30;
const OUT_FILE = path.join(__dirname, "form4-frequency-results-midcap.json");
