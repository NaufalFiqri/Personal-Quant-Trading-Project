...
- Whether the RSI/stop-loss interaction found above (a tight stop cutting mean-reversion trades short) is worth its own validation pass, or just a config knob to revisit once a real mean-reversion strategy is being seriously evaluated.
